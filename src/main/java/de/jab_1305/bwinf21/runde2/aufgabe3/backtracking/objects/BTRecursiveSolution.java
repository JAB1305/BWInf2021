...
public class BTRecursiveSolution implements Solution {
    ...
    public BTRecursiveSolution(ArrayList<BTDigit> digits, int maxN) {
        this.digits = digits;
    ...
    public void method(boolean backTrack) throws RuntimeException {

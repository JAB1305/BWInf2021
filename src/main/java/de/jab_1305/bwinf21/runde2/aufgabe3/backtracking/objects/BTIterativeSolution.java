...
public class BTIterativeSolution implements Solution {
    ...
    public BTIterativeSolution(ArrayList<BTDigit> digits, int maxN) {
        this.digits = digits;
    ...
    public void method() {
        boolean backTrackInNextIteration = false;
        while (!solutionFound) {
            if (!backTrackInNextIteration) {
                ...
                if (this.nextDigitIndex < this.digits.size()) {
                    backTrackInNextIteration = false;
                }
            }
            else {
                backTrackInNextIteration = false;
